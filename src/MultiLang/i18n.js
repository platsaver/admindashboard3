...
const resources = {
  en: {
    translation: {
      ...
      searchPersonnel: "Search for personnel ...",
      ...
      personnelInactive: "Inactive",
      personnelPartner: "Partner",
      personnelAllOption: "All",
      personnelActiveOption: "Active",
      personnelInactiveOption: "Inactive",
      personnelNameWarning: "Personnel name is required.",
      personnelRoleWarning: "Personnel role is required.",
      personnelEmailWarning: "Personnel email is required.",
      personnelStatusWarning: "Personnel status is required.",
      personnelInvalidEmailWarning: "Invalid email format.",
  ...
  vi: {
    translation: {
      ...
      Consultant: "Tư vấn",
      Analyst: "Phân tích",
      LogisticManager: "Quản lý logistics",
      personnelList: "Danh sách nhân sự",
      addPersonnel: "Thêm nhân sự",
      editPersonnel: "Chỉnh sửa nhân sự",
      deletePersonnel: "Xóa nhân sự",
      searchPersonnel: "Tìm kiếm nhân sự ...",
      personnelDetails: "Thông tin chi tiết nhân sự",
      personnelName: "Tên nhân sự",
      personnelRole: "Vai trò nhân sự",
      personnelEmail: "Email nhân sự",
      personnelStatus: "Trạng thái nhân sự",
      personnelActive: "Đang hoạt động",
      personnelInactive: "Không hoạt động",
      personnelPartner: "Đối tác",
      personnelDeleteTitle: "Xóa nhân sự",
      personnelDeleteWarning: "Bạn có chắc chắn muốn xóa nhân sự này không?",
      personnelAllOption: "Tất cả",
      personnelActiveOption: "Đang hoạt động",
      personnelInactiveOption: "Không hoạt động",
      personnelNameWarning: "Tên nhân sự là bắt buộc.",
      personnelRoleWarning: "Vai trò nhân sự là bắt buộc.",
      personnelEmailWarning: "Email nhân sự là bắt buộc.",
      personnelStatusWarning: "Trạng thái nhân sự là bắt buộc.",
      personnelInvalidEmailWarning: "Định dạng email không hợp lệ.",
      personnelPartnerWarning: "Đối tác của nhân sự là bắt buộc.",
      policies: [
